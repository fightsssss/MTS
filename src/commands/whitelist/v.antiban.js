...
module.exports = {
    name: 'antiban',
    description: 'Désactive / Active l\'antiban',
    aliases: ['antiban', 'Antiban'],
    ...
    async execute(message, args, client, lang) {
        ...
        if (args[0] === 'on') {
            ...
            message.channel.send({
                embed: {
                    color: color,
                    description: `${lang.BanAction} ${lang.AntiBanEnable} \n ${lang.BanAuthor} <@${message.author.id}>`,
                    footer: {
            ...
            db.set(`${message.guild.id}.antiban`, false);
            message.channel.send({
                embed: {
                    color: color,
                    description: `${lang.BanAction} ${lang.AntiBanDisable} \n ${lang.BanAuthor} <@${message.author.id}>`,
                    footer: {
                        icon_url: `${client.user.displayAvatarURL()}`,
                        text: `${client.user.username} `,
                    },
            ...
            message.channel.send({
                embed: {
                    color: color,
                    description: `${lang.WhitelistPreciseOFFoON} ${lang.AntiBanFinalWord}`,
                    footer: {
                        icon_url: `${client.user.displayAvatarURL()}`,
                        text: `${client.user.username} `,
                    },
