...
module.exports = {
    ...
    async execute(message, args, client, lang) {
        ...
        const Nopresencestatutsoutien = new MessageEmbed()
            .setColor(color)
            .setDescription(`${emojis.alert} ${lang.MassAddErrorRoleIncorect}`)
            .setTimestamp()
            .setFooter(`${client.user.username} `, `${client.user.displayAvatarURL()}`);

        const rolenotfound = new Discord.MessageEmbed()
            .setColor(color)
            .setDescription(`${emojis.alert} <@${message.author.id}> ${lang.MassAddErrorRoleNotFound}`)
            .setTimestamp()
            .setFooter(`${client.user.username} `, `${client.user.displayAvatarURL()}`);

        const roleprblm = new Discord.MessageEmbed()
            .setColor(color)
            .setDescription(`${emojis.alert} <@${message.author.id}> ${lang.MassAddErrorRoleHighest}`)
            .setTimestamp()
            .setFooter(`${client.user.username} `, `${client.user.displayAvatarURL()}`);

        const rolemanaged = new Discord.MessageEmbed()
            .setColor(color)
            .setDescription(`${emojis.alert} <@${message.author.id}> ${lang.MassAddErrorRoleManaged}`)
            .setTimestamp()
            .setFooter(`${client.user.username} `, `${client.user.displayAvatarURL()}`);
        ...
        const commenco = new Discord.MessageEmbed()
            .setColor(color)
            .setDescription(`${emojis.loading} **<@${message.author.id}>** ${lang.MassAddMessage} **${role}** ${lang.MassAddMessageAdding}`)
            .setTimestamp()
            .setFooter(`${client.user.username} `, `${client.user.displayAvatarURL()}`);
        ...
        const finito = new Discord.MessageEmbed()
            .setColor(color)
            .setDescription(`${emojis.yes} <@${message.author.id}> ${lang.MassAddMessage} **${role}** ${lang.MassAddMessageAdded}`)
            .setTimestamp()
            .setFooter(`${client.user.username} `, `${client.user.displayAvatarURL()}`);
